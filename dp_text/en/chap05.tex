...
Due to metric tensor degeneracy, the space is not geodesically maximal. To see that singularity is not only coordinate one, by calculating the Ricci curvature we see (fig. \ref{fig:N=3_Ricci}), that it diverges in points $(\lambda_d;\pm\chi_d)$ (singularities of the metric tensor), see sections in $\chi$-direction on fig. \ref{fig:N=3_Ricci_section}, proving the singularity is not only coordinate, but \emph{physical}.
