...
\begin{thm}[Von Neumann-Wigner]\citet[page 305]{landau}
    \label{thm:n-2}
...
\begin{thm}[Hopf-Rinow Theorem]\citet[page 125]{petersen}
    ...
    \end{itemize}
\end{thm}
\begin{thm}[Modified Hopf-Rinow Theorem]\citet[Chapter 3]{claudio}
