...
We can see it's physical meaning on state manifolds, imagining \emph{quantum quench} (rapid change of some Hamiltonian parameters). In which case $F$ is the probability that system will remain in the new ground state and $1-F$ is the probability of exciting the system during this quench, 
