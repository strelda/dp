...
To understand why the gauge potential generates some calibrational invariance, let's define the Berry connection.
...
These singularities appear in the system due to energy spectrum degeneracies, in the case of ground state manifold, when $E_1-E_0=0$. These points are called \emph{diabolic}, because of the energy spectrum shape in the $\llambda)$ parameter space.\footnote{https://en.wikipedia.org/wiki/Diabolo}