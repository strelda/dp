...
The Lipkin-Meshkov-Glick (LMG) model is a simple model manifesting the quantum phase transitions. It represents a many-body fermion system. This chapter aims on understanding the properties of the ground state and its influence on different driving protocols.
...
Another special case is $N=5$. Between every neighboring energy levels, there are many degeneracies, as can be seen in Fig. \ref{fig:singularitiesBetweenEnergiesN=5}. $E_0=E_1$ degeneracy lies approximately on the line called \emph{separatrix} (see Chap. \ref{chap:infiniteDimensionLimit}) and other singularities are distributed around. The $\chi\leftrightarrow-\chi$ symmetry holds for all of them.
