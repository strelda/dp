...
\def\Dedication{%
The biggest thanks go to my supervisor prof. Pavel Cejnar, who was willing to discuss the results and the theory for long hours. Explaining my ideas or the topic of this thesis to my friends was always helpful. Namely, Michal Grňo, Kuba Novotný and Martin Zika were always willing to discuss anything concerning quantum mechanics or differential geometry, allowing me to sort my thoughts. 
}

% Abstract (recommended length around 80-200 words; this is not a copy of your thesis assignment!)
\def\Abstract{%
The theory of quantum driving is presented and reformulated into the language of differential geometry. The general fidelity driving in a two level Hamiltonian system is then analyzed with special importance of the fidelity dependence. For the Lipkin-Meshkov-Glick the adiabatic and close adiabatic drivings are calculated, along with the geometrical structure of its state manifolds.
}

% 3 to 5 keywords (recommended), each enclosed in curly braces
\def\Keywords{%
{fidelity} {adiabaticity} {driving} {quench} {Lipkin}
}
...
\include{chap03_driving}
\include{chap04_stateDriving.tex}
% \include{chap05_spin}
\include{chap06_twoLevel}
\include{chap07_lipkin}
\include{chap04_groundManifold}
