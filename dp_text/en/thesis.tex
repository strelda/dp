...
\def\Dedication{%
Huge thanks go to my supervisor prof. Pavel Cejnar, who was willing to discuss the results and the theory anytime my mind needed some guidance. It is also worth mentioning here that some of my friends were willing to discuss anything concerning quantum mechanics or differential geometry. I hereby thank Michal Grňo, Jakub Novotný and Martin Zika for allowing me to sort my thoughts in this way. 
}

% Abstract (recommended length around 80-200 words; this is not a copy of your thesis assignment!)
\def\Abstract{%
The theory of quantum driving is presented and reformulated using the language of differential geometry. The general fidelity driving in a two level Hamiltonian system is then analyzed with special importance of the fidelity time dependence. For the Lipkin-Meshkov-Glick model the adiabatic and close adiabatic drivings are calculated, along with the geometrical structure of its state manifolds.
}

% 3 to 5 keywords (recommended), each enclosed in curly braces
\def\Keywords{%
{fidelity} {adiabaticity} {driving} {quench} {Lipkin-Meshkov-Glick}
}
