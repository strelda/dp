...
\begin{figure}[H]
    ...
    \caption{Fidelity of quench from $(\lambda_i;\chi_i)=(0;0)$ to the coordinate $(\lambda;\chi)$. \greenn{Minimal line} (\greenn{green line}) is plotted for comparison.}
