...
In the whole thesis, classical formulation of quantum mechanics with some parts described using differential geometry is used. Here, the complete reformulation of quantum mechanics and the bridge between this theory and the one already formulated is introduced. Reformulating the whole theory of quantum driving into the language of differential geometry might give some new insights, but it is beyond the scope of this thesis.
