...
\end{equation}
for functions $b_n^(1)$ from Eq. \ref{eq:bnAPT}. For more detail, see \red{Felipe unpublished report}.
...
\newpage
\subsection{Energy variance}
Energy variance for the linear driving case can be seen on Fig \ref{fig:densVariance}, as a function of time and final time. $\Omega$ and final time.
\red{Why is it almost the same as fidelity of geodesical driving???}
\begin{figure}[H]
    \centering
