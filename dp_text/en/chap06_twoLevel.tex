...
Before we move to more complicated Hamiltonian model, we investigate a simple two level system. To understand the general behavior of fidelity on Hamiltonian spectrum, two analytically solvable drivings -- \emph{geodesic} and \emph{linear} -- will be investigated.
