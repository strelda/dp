...
\begin{figure}[H]
    \centering
    \includegraphics[scale=1.2]{../img/infidelityInTimePlot.pdf}
...
\begin{figure}[H]
    ...
    \label{fig:linear_finalInfidelity}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Logarithm of final fidelity $-\log(F_f)$ has two regimes. Visualization of smooth and chaotic regimes.}
    \label{fig:dens2}
\end{figure}
