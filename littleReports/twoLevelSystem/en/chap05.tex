...
\begin{equation}
    \cos \left(t \sqrt{\frac{\pi ^2}{T_f^2}+4 s^2}\right)=-\frac{8 s^2 T_f^2}{\pi ^2}.
\end{equation}
For $t=T_f$ and substitution $T_s\coloneqq 2s T_f$, we get
\begin{equation}
    \cos \left(\sqrt{T_s^2+\pi^2}\right)=-\frac{2 T_s^2}{\pi ^2},
\end{equation}
which has only one positive solution $T_s\approx 2.022$.

This proves that the fidelity dependence on final time in logarithmic scale has only one spike going to $0$, see Fig. \ref{fig:infidelityTfPlotLog}.
