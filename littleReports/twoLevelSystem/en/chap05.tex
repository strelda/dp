...
\begin{equation}
    T=\sqrt{(2 \pi  k)^2-\pi ^2} \text{  for }k\in \mathbb{N}.
    \label{eq:solutionT}
\end{equation}
The numerical check can be seen on Fig. \ref{fig:fidelityZeros}. Because $F=1$ has solutions \ref{eq:solutionT}, the its dependence on final time in logarithmic scale has spikes going to $0$, see Fig. \ref{fig:infidelityTfPlotLog}, and their density is proportional to $T_f^2$.
\begin{figure}[H]
    \centering
