...
\frame{
  ...
  $\Omega(t)$ lze volit libovolně, v rámci práce byl zvolen geodetický driving $\Omega(t)= \text{konst}$.
...
\frame{
  \frametitle{Otázka oponenta ohledně Dvouhladinového systému}
  \framesubtitle{Metrický tenzor}
  Zafixujme jednu souřadnici -- $(\Delta;\Omega(t))$ je
  \begin{equation}
  ...
  \end{equation}
  $\Rightarrow$ existuje závislost $\Omega(t),\Delta(t)$, že křivka lineární v parametrickém prostoru je geodetikou.
}
